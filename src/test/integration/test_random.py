...
def test_random_read_async():
	lib.run_benchmark("--duration 1 --workload RU --startKey 0 --keys 100 --async")
...
def test_random_read_batch():
	lib.run_benchmark("--duration 1 --workload RU --startKey 0 --keys 100 --batchSize 16")
...
def test_random_read_batch_async():
	lib.run_benchmark("--duration 1 --workload RU --startKey 0 --keys 100 --batchSize 16 --async")
