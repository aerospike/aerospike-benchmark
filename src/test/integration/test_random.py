...
def test_random_read_replace_empty():
...
def test_random_read_replace():
	lib.run_benchmark(["--workload", "I", "--start-key", "0", "--keys", "100"])
	lib.run_benchmark(["--duration", "1", "--workload", "RR", "--start-key", "0", "--keys", "100"], do_reset=False)
...
def test_random_read_replace_async():
	lib.run_benchmark(["--workload", "I", "--start-key", "0", "--keys", "100", "--async"])
	lib.run_benchmark(["--duration", "1", "--workload", "RR", "--start-key", "0", "--keys", "100", "--async"], do_reset=False)
...
def test_random_read_replace_batch():
	lib.run_benchmark(["--workload", "I", "--start-key", "0", "--keys", "100"])
	lib.run_benchmark(["--duration", "1", "--workload", "RR", "--start-key", "0", "--keys", "100", "--batch-size", "16"], do_reset=False)
...
def test_random_read_replace_batch_async():
	lib.run_benchmark(["--workload", "I", "--start-key", "0", "--keys", "100", "--async"])
	lib.run_benchmark(["--duration", "1", "--workload", "RR", "--start-key", "0", "--keys", "100", "--batch-size", "16", "--async"], do_reset=False)
...
def test_random_read_update_read_only():
	lib.run_benchmark(["--workload", "I", "--start-key", "0", "--keys", "100"])

	recs = [lib.get_record(key) for key in range(0, 100)]

	lib.run_benchmark(["--duration", "1", "--workload", "RR,100", "--start-key", "0", "--keys", "100"], do_reset=False)
...
def test_random_read_update_read_only_async():
	lib.run_benchmark(["--workload", "I", "--start-key", "0", "--keys", "100", "--async"])

	recs = [lib.get_record(key) for key in range(0, 100)]

	lib.run_benchmark(["--duration", "1", "--workload", "RR,100", "--start-key", "0", "--keys", "100", "--async"], do_reset=False)
