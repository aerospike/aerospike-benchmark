...
DEBIAN_DEPS="libtool automake autoconf m4 cmake make gcc g++ build-essential zlib1g-dev libssl-dev libyaml-dev ruby-dev curl git rsync"
UBUNTU_DEPS="libtool automake autoconf m4 cmake make gcc g++ build-essential zlib1g-dev libssl-dev libyaml-dev ruby-dev curl git rsync"
...
REDHAT_DEPS="libtool automake autoconf m4 cmake make gcc gcc-c++ zlib zlib-devel openssl-devel libyaml-devel ruby-devel git rsync"
